...
function translateThaiToLannaFull(string $word): array {
    ...
    $specialMap = [
        ...
        'สวัสดี' => ['lanna' => "ส\u{F0E8}\u{F0B0}สดี", 'reading' => '[สวัด-สะ-ดี]', 'meaning' => 'คำทักทาย สวัสดิภาพ'],
        'สัสสดี' => ['lanna' => "ส\u{F0E8}\u{F0B0}สดี", 'reading' => '[สวัด-สะ-ดี]', 'meaning' => 'คำทักทาย สวัสดิภาพ'],
        ...
        'ตัวธัมม์' => ['lanna' => 'ᨲ᩠ᩅᩫᨵᨾ᩠ᨾ᩺', 'reading' => '[ตั๋ว - ทัม]', 'meaning' => 'น. อักษรธรรมล้านนา (ตัวเมือง)'],
        'ตั๋วธัมม์' => ['lanna' => 'ᨲ᩠ᩅᩫᨵᨾ᩠ᨾ᩺', 'reading' => '[ตั๋ว - ทัม]', 'meaning' => 'น. อักษรธรรมล้านนา (ตัวเมือง)'],
        'ตัวธรรม' => ['lanna' => 'ᨲ᩠ᩅᩫᨵᨾ᩠ᨾ᩺', 'reading' => '[ตั๋ว - ทัม]', 'meaning' => 'น. อักษรธรรมล้านนา (ตัวเมือง)'],
        'ตั๋วธรรม' => ['lanna' => 'ᨲ᩠ᩅᩫᨵᨾ᩠ᨾ᩺', 'reading' => '[ตั๋ว - ทัม]', 'meaning' => 'น. อักษรธรรมล้านนา (ตัวเมือง)'],
        'ธัมม์' => ['lanna' => 'ᨵᨾ᩠ᨾ᩺', 'reading' => '[ทัม]', 'meaning' => 'น. ธรรม คำสอน'],
        'ธรรม' => ['lanna' => 'ᨵᨾ᩠ᨾ᩺', 'reading' => '[ทัม]', 'meaning' => 'น. ธรรม คำสอน'],
    ];
