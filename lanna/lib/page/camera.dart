...
1. สระหน้า (Leading Vowels):
   - สระแอ (ᩯ) 2 ขาซ้ายสุด
   - ไม้ไก๋/สระไอ (ᩱ) หรือ ไม้ใค/สระใอ (ᩲ) ทรงสูงเลยพยัญชนะ
   - สระเอ (ᩮ), สระโอ (ᩰ)

2. พยัญชนะหลัก (Base Consonants):
   - กะ ᨠ, ขะ ᨡ, คะ ᨣ, ฅะ ᨤ, งะ ᨦ, จะ ᨧ, ฉะ ᨨ, ชะ ᨩ (หัวบนม้วนหางย้อยล่าง), ซะ ᨪ, ญะ ᨬ
   - ตะ ᨲ, ถะ ᨳ, ทะ ᨴ, ธะ ᨵ, นะ ᨶ
   - บะ/ปะ ᨷ, ปะหางยาว ᨸ, ผะ ᨹ, ฝะ ᨺ, พะ ᨻ (โค้งกลมคล้าย พ), ฟะ ᨼ, ภะ ᨽ, มะ ᨾ, ยะ ᨿ
   - ระ ᩁ (คล้าย ร/ธ), ละ ᩃ (กลมม้วน), วะ ᩅ, สะ ᩈ, หะ ᩉ, อะ ᩋ, ฮฮก ᩌ

3. ตัวสะกดห้อยและตัวควบใต้ล่าง (Subjoined Sakot & Medials):
   - ย ห้อย (᩠ᨿ) (ทำเสียงสระเอีย หรือ ย สะกด เช่น ᨩ᩠ᨿ เชีย, ᨻ᩠ᨿ เพีย, ᩁᩣ᩠ᨿ ราย)
   - ว ห้อย (᩠ᩅ) (สระอัว หรือ ว สะกด เช่น ᨤ᩠ᩅ คว), ม ห้อย (᩠ᨾ เช่น ᩉ᩠ᨾ หม), ง ห้อย (᩠ᨦ)
   - น ห้อย (᩠ᨶ), ด ห้อย (᩠ᨯ), บ ห้อย (᩠ᨷ), ก ห้อย (᩠ᨠ)
   - ล หาง (ᩖ), ร หางกวาด (ᩕ), สระอุ (ᩩ), สระอู (ᩪ)

4. สระบนและเครื่องหมายวรรณยุกต์ (Upper Vowels & Tone Marks):
   - สระอิ (ᩥ), สระอี (ᩦ), สระอึ (ᩧ), สระอือ (ᩨ), ไม้กั๋ง (ᩢ), สระอัว (ᩫ), นิคหิต/สระอำ (ᩴ)
   - ไม้เหยาะ (ไม้เอก ᩵ - จุดหรือขีดบน), ไม้ขอช้าง (ไม้โท ᩶ - โค้งบน), ไม้ซัด (᩺/᩹)
...
4. ข้อกำหนดสำคัญ: ห้ามเดาหรือบังคับให้เป็นเพียงคำใดคำหนึ่ง จงอ่านตามตัวอักษรจริงที่ปรากฏในภาพอย่างอิสระและเป็นกลาง
