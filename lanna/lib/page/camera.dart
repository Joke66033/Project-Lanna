...
1. ระดับกลาง (Base / Middle Level - พยัญชนะหลัก):
   - พยัญชนะ 33 ตัวในวรรคและเศษวรรค (กะ ᨠ, ขะ ᨡ, ฃะ ᨢ, คะ ᨣ, ฅะ ᨤ, ฆะ ᨥ, งะ ᨦ, จะ ᨧ, ฉะ ᨨ, ชะ ᨩ, ซะ ᨪ, ฌะ ᨫ, ญะ ᨬ, ตะ ᨲ, ถะ ᨳ, ทะ ᨴ, ธะ ᨵ, นะ ᨶ, ปะ ᨷ, ผะ ᨹ, พะ ᨻ, ฟะ ᨼ, ภะ ᨽ, มะ ᨾ, ยะ ᨿ, ระ ᩁ, ละ ᩃ, วะ ᩅ, สะ ᩈ, หะ ᩉ, ฬะ ᩊ, อะ ᩋ, ฮฮก ᩌ)
   - สระหน้า: สระเอ (ᩮ), สระแอ (ᩯ), สระโอ (ᩰ), สระใอ (ᩱ), สระไอ (ᩲ)
   - สระหลัง: สระอา (ᩣ/ᩤ - สระอาหางยาว), สระอะ (ᩡ)
2. ระดับล่าง (Lower / Subjoined Level - ตัวห้อยและสระล่าง):
   - ตัวสะกดห้อย (Subjoined Sakot ᩠): ตัวสะกดวางใต้พยัญชนะต้น เช่น ᩠ᨦ (ง ห้อย), ᩠ᨶ (น ห้อย), ᩠ᨾ (ม ห้อย), ᩠ᨯ (ด ห้อย), ᩠ᨷ (บ ห้อย), ᩠ᨠ (ก ห้อย)
   - สระล่าง: สระอุ (ᩩ), สระอู (ᩪ)
   - เครื่องหมายควบ/ห้อยพิเศษ: ไม้กังลาย (ว ห้อย ᩠ᩅ), ไม้เกี๋ยง (ย ห้อย ᩠ᨿ), ร หางกวาด (ᩕ), ล หาง (ᩖ)
3. ระดับบน (Upper Level - สระบนและวรรณยุกต์):
   - สระบน: สระอิ (ᩥ), สระอี (ᩦ), สระอึ (ᩧ), สระอือ (ᩨ), ไม้กั๋ง/ไม้หันอากาศ (ᩢ), สระอัว (ไม้กั่งลาย ᩫ), นิคหิต/สระอำ (ᩴ)
   - วรรณยุกต์และเครื่องหมายกำกับ: ไม้เหยาะ (ไม้เอก ᩵), ไม้ขอช้าง (ไม้โท ᩶), ไม้ซัด (᩺/᩹)
...
ส่งคืนผลลัพธ์เป็น JSON บริสุทธิ์ (Pure JSON เท่านั้น ห้ามใส่ markdown หรือข้อความอื่น):
{
  "detected_text": "คำแปลภาษาไทยมาตรฐานที่ถูกต้องที่สุด",
  "lanna_text": "อักขระล้านนา Tai Tham Unicode ที่สมบูรณ์",
  "reading": "[คำอ่านสำเนียงคำเมืองล้านนา]",
  "meaning": "คำอธิบายความหมายและบริบทตามประวัติศาสตร์/ภาษาศาสตร์",
