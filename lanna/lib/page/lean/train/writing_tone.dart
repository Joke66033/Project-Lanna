...
class WritingTonePage extends StatefulWidget {
  const WritingTonePage({super.key});

  @override
  State<WritingTonePage> createState() => _WritingTonePageState();
}

class _WritingTonePageState extends State<WritingTonePage> {
  ...
  Future<void> _loadData() async {
    try {
      final chars = await _charService.getAllCharacters(categoryCharId: 'CL0006');
      if (mounted) {
        setState(() {
