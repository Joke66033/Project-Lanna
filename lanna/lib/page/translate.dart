...
class _TranslatePageState extends State<TranslatePage> {
  ...
  Map<String, String> _translateKamMueangOffline(String thaiText) {
    ...
    const phraseDict = {
      ...
      'สูงเม่น': 'สุงเหมั้น',
      'เสริมงาม': 'เสริมงาม',
      // คำศัพท์และสถานที่สำคัญทางประวัติศาสตร์
  ...
  Future<Map<String, dynamic>?> _callGeminiAi(String promptText) async {
    ...
    const models = ['gemini-3.5-flash-lite', 'gemini-3.5-flash', 'gemini-3.6-flash', 'gemini-flash-latest', 'gemini-flash-lite-latest'];
...
* คำศัพท์เฉพาะและนามมงคล / โบราณสถานและประตูเมือง:
  - "ประตูช้างเผือก" แปลว่า "ปตูจ๊างเผือก" (คำอ่าน: [ปะ-ตู-จ๊าง-เผือก], ตั๋วเมือง: "ปตูจ_้า_งเ_ผื_อ_ก" หมายเหตุ: ประตูเมืองล้านนาโบราณเขียน ปตู, ช้าง ออกเสียงและเขียนเป็น จ๊าง "จ_้า_ง", เผือก เขียน "เ_ผื_อ_ก")
  - "ประตูท่าแพ" แปลว่า "ปตูท่าแพ" (คำอ่าน: [ปะ-ตู-ท่า-แพ], ตั๋วเมือง: "ปตูท่าแ_พ")
  - "ประตูสวนดอก" แปลว่า "ปตูสวนดอก" (คำอ่าน: [ปะ-ตู-สวน-ดอก], ตั๋วเมือง: "ปตูส_ว_นด_อ_ก")
  - "ประตูเชียงใหม่" แปลว่า "ปตูเชียงใหม่" (คำอ่าน: [ปะ-ตู-เชียง-ใหม่], ตั๋วเมือง: "ปตูช_ย_งให_ม_่")
  - "ประตูแสนปุง" แปลว่า "ปตูแสนปุง" (คำอ่าน: [ปะ-ตู-แสน-ปุง], ตั๋วเมือง: "ปตูแ_ส_นปุ_ง")
  - "ประตู..." (ประตูเมือง) แปลว่า "ปตู..." (คำอ่าน: [ปะ-ตู-...])
  - "ช้าง" แปลว่า "จ๊าง" (คำอ่าน: [จ๊าง], ตั๋วเมือง: "จ_้า_ง")
  - "เมืองอินทร์" แปลว่า "เมืองอินทร์" (คำอ่าน: [เมือง-อินทร์], ตั๋วเมือง: "เมื_องอิ_นท_ร์")
  - "ผองจาย" แปลว่า "ผองจาย" หรือ "ป้อจาย" (คำอ่าน: [ผอง-จาย], ตั๋วเมือง: "ผ_งจา_ย" หมายเหตุ: สระออ + แม่กง ลดรูปเป็น ผะ + งะห้อย "ผ_ง" และ จาย เป็น "จา_ย")
  - "มีความสุข" / "ความสุข" แปลว่า "มีความสุข" / "ความสุข" (คำอ่าน: [มี-ความ-สุข] / [ความ-สุข], ตั๋วเมือง: "มีค_วา_มสุ_ข" / "ค_วา_มสุ_ข" หมายเหตุ: คำว่า "ความ" มี ว ห้อยใต้ ค และ ม ห้อยใต้ า เป็น "ค_วา_ม", คำว่า "สุข" มี ข ห้อยใต้ สุ เป็น "สุ_ข")
  - "ราชัน" แปลว่า "ราชัน" (คำอ่าน: [รา-ชัน], ตั๋วเมือง: "ราชั_น" ประกอบด้วย ร + า + ช + ั + _น)
  - "ร่ำรวย" / "รวย" แปลว่า "ร่ำรวย" / "รวย" (คำอ่าน: [ร่ำ-รวย], ตั๋วเมือง: "รํ่_วว_ย" / "ร_ว_ย" หมายเหตุ: คำว่า "ร่ำรวย" พยางค์หน้าใช้พยัญชนะ ร ตัวเดียว โดยมี นิคหิต+ไม้เอก ด้านบน และมี วะห้อย "_ว" อยู่ใต้ฐาน ร ตามด้วย วะ และ ยะห้อย "_ย" เป็น "รํ่_วว_ย")
...
2. เครื่องหมายขีดล่าง "_" ให้ใส่เฉพาะหน้าพยัญชนะที่เป็น "ตัวสะกดท้ายพยางค์" หรือ "พยัญชนะซ้อนสังโยค/อักษรนำ" เท่านั้น เช่น:
   ...
   * กินข้าว -> "กิ๋_นข้า_ว"
   * กับหยัง -> "กั_บห_ยั_ง"
   * แม่ กก: ผัก -> "ผั_ก", นก -> "น_ก", ลูก -> "ลู_ก", สุข -> "สุ_ข"
   * แม่ กง: กงหาง -> "ก_งหา_ง", สอง -> "ส_ง", เมือง -> "เมื_อง", ผอง -> "ผ_ง", จอง -> "จ_ง", ทอง -> "ท_ง" (สระออ + แม่กง ลดรูปเป็น พยัญชนะต้น + _ง)
   * แม่ กด: วัด -> "วั_ด", ปิด -> "ปิ_ด", มด -> "ม_ด"
   * แม่ กน: กิ๋น -> "กิ๋_น", บ้าน -> "บ้า_น", น่าน -> "น่า_น", ราชัน -> "ราชั_น", วัน -> "วั_น", อินทร์ -> "อิ_นท_ร์"
   * แม่ กบ: สบ -> "ส_บ", แอบ -> "แ_อบ", กับ -> "กั_บ"
   * แม่ กม: งาม -> "งา_ม", สาม -> "สา_ม", ความ -> "ค_วา_ม"
   * แม่ เกย: โตย -> "โต_ย", ดอย -> "ด_อย", จาย -> "จา_ย"
   * แม่ เกอว / สระอัวลดรูป: แมว -> "แม_ว", ข้าว -> "ข้า_ว", แอ่ว -> "แอ่_ว", ตั๋ว -> "ตั๋_ว", รวย -> "ร_ว_ย", สวย -> "ส_ว_ย", ร่ำรวย -> "รํ่_วว_ย"
   * อักษรนำ/ควบ: หมา -> "ห_มา", พระ -> "พ_ระ", แพร่ -> "แ_พ_ล่", ความ -> "ค_วา_ม", ฉลาด -> "จ_รา_ด" (คำอ่าน: "[จะ-หลาด]"), ตลาด -> "ต_ลา_ด" (คำอ่าน: "[ตะ-หลาด]")
