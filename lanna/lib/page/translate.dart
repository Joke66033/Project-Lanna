...
class _TranslatePageState extends State<TranslatePage> {
  ...
  Map<String, String> _translateKamMueangOffline(String thaiText) {
    var km = thaiText;
    const phraseDict = {
      'สวัสดีตอนเช้า': 'สวัสดีตอนเจ้า',
      'สวัสดีตอนสาย': 'สวัสดีตอนสาย',
      'สวัสดีตอนเที่ยง': 'สวัสดีตอนเที่ยง',
      'สวัสดีตอนบ่าย': 'สวัสดีตอนบ่าย',
      'สวัสดีตอนเย็น': 'สวัสดีตอนแลง',
      'สวัสดีตอนค่ำ': 'สวัสดีตอนค่ำ',
      'สวัสดีตอนกลางคืน': 'สวัสดีเมื่อคืน',
